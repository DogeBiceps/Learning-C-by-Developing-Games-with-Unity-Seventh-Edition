    ...
    "Karnik", "Suprotim", "Agarwal", "Rajesh", "Tejas", "Ram", "Sita", "Sabnis", "Pendse", "Sita"
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            // Run Hashset vs List Performances. 
            // Hashset is faster than List in Add, Contains and Remove operations. This is because Hashset uses Hashing to store data, and can just add or remove hash value for any given data.
            // List on the other hand, has to traverse through the list to find the data, which is slower than Hashset.
            // Contains operation is faster in List than Hashset. This is because of the size of the data set. Hashset is faster in Contains operation when the data set is large.
            // Generally, list is better with small data sets, due to it being cache efficient. Hashset is better with large data sets, as hashkey is faster to find than traversing through the list.
